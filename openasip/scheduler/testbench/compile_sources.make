...
llvm:
	#echo $(GCCLLVM) -I$(TESTBENCH_INCLUDE_DIR) $(EXTRA_FLAGS) $(EXTRA_TCECC_FLAGS) -o generated_program.be.bc --emit-llvm $(SCHEDULER_TESTER_FLAGS) $(SOURCE_FILES)
	...
	$(GCCLLVM) -I$(TESTBENCH_INCLUDE_DIR) $(EXTRA_FLAGS) $(EXTRA_TCECC_FLAGS) -o generated_program.64.bc --little-endian64 --emit-llvm $(SCHEDULER_TESTER_FLAGS) $(SOURCE_FILES)

schedule: llvm
	echo "There must be link to openasip/scheduler/testbench/ADF directory in src dir."
