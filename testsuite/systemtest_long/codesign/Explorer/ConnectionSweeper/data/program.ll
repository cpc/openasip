...
; Function Attrs: argmemonly nofree noinline noreturn nounwind
...
define internal fastcc i32 @main(i32 %argc, ptr nocapture readnone %argv, ptr nocapture readnone %envp) unnamed_addr #3 {
entry:
  br label %for.body.i
...
attributes #1 = { argmemonly nofree noinline noreturn nounwind "frame-pointer"="all" "min-legal-vector-width"="0" "no-builtins" "no-trapping-math"="true" "stack-protector-buffer-size"="8" }
