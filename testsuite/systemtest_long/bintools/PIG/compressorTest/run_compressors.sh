...
$PROGE -t -b $BEM -i $IDF -o $DIR0 $ADF || eexit "ProGe failed! Check that data/minimal.idf is up to date!"

# generate processor for simple dictionary (1)
$PROGE -t -b $BEM -i $IDF -o $DIR1 $ADF || eexit "ProGe failed! Check that data/minimal.idf is up to date!"

# generate processor for move slot dictionary (2)
$PROGE -t -b $BEM -i $IDF -o $DIR2 $ADF || eexit "ProGe failed! Check that data/minimal.idf is up to date!"
