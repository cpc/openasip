...
void MixColumInt(unsigned int *state)
{
	unsigned int aux_state[4];
	unsigned int b0, b1, b2, b3;
	
	b0 = mul(2,byte0(state[0])) ^ mul(3,byte0(state[1])) ^ byte0(state[2]) ^ byte0(state[3]);
	b1 = mul(2,byte1(state[0])) ^ mul(3,byte1(state[1])) ^ byte1(state[2]) ^ byte1(state[3]);
	b2 = mul(2,byte2(state[0])) ^ mul(3,byte2(state[1])) ^ byte2(state[2]) ^ byte2(state[3]);
	b3 = mul(2,byte3(state[0])) ^ mul(3,byte3(state[1])) ^ byte3(state[2]) ^ byte3(state[3]);
	
	bytes2word(b0,b1,b2,b3,aux_state[0]);
	
	b0 = byte0(state[0]) ^mul(2,byte0(state[1])) ^ mul(3,byte0(state[2])) ^ byte0(state[3]);
	b1 = byte1(state[0]) ^mul(2,byte1(state[1])) ^ mul(3,byte1(state[2])) ^ byte1(state[3]);
	b2 = byte2(state[0]) ^mul(2,byte2(state[1])) ^ mul(3,byte2(state[2])) ^ byte2(state[3]);	
	b3 = byte3(state[0]) ^mul(2,byte3(state[1])) ^ mul(3,byte3(state[2])) ^ byte3(state[3]);
	
	bytes2word(b0,b1,b2,b3,aux_state[1]);	
	
	b0 = byte0(state[0]) ^ byte0(state[1]) ^mul(2,byte0(state[2])) ^ mul(3,byte0(state[3]));
	b1 = byte1(state[0]) ^ byte1(state[1]) ^mul(2,byte1(state[2])) ^ mul(3,byte1(state[3]));		
	b2 = byte2(state[0]) ^ byte2(state[1]) ^mul(2,byte2(state[2])) ^ mul(3,byte2(state[3]));
	b3 = byte3(state[0]) ^ byte3(state[1]) ^mul(2,byte3(state[2])) ^ mul(3,byte3(state[3]));	
	
	bytes2word(b0,b1,b2,b3,aux_state[2]);
	
	b0 = mul(3,byte0(state[0])) ^ byte0(state[1]) ^ byte0(state[2]) ^ mul(2,byte0(state[3]));
	b1 = mul(3,byte1(state[0])) ^ byte1(state[1]) ^ byte1(state[2]) ^ mul(2,byte1(state[3]));
	b2 = mul(3,byte2(state[0])) ^ byte2(state[1]) ^ byte2(state[2]) ^ mul(2,byte2(state[3]));
	b3 = mul(3,byte3(state[0])) ^ byte3(state[1]) ^ byte3(state[2]) ^ mul(2,byte3(state[3]));
...
void SubShiftInt(unsigned int *state)
{	
...
void round_encInt(unsigned int *block, unsigned int *key, unsigned int round)
{
	SubShiftInt(block);
	MixColumInt(block);
...
void lround_encInt(unsigned int *block, unsigned int *key)
{
	SubShiftInt(block);	
...
void
encrypt_aes2Int(unsigned int *block, unsigned int *expandedkey)
{
...
round_encInt(block, expandedkey, 1);
round_encInt(block, expandedkey, 2);
round_encInt(block, expandedkey, 3);
round_encInt(block, expandedkey, 4);
round_encInt(block, expandedkey, 5);
round_encInt(block, expandedkey, 6);
round_encInt(block, expandedkey, 7);
round_encInt(block, expandedkey, 8);
round_encInt(block, expandedkey, 9);
lround_encInt(block, expandedkey);
