...
/* Debug macro for printing out static tables */ 
#define print_table(x) {\
int i; printf(#x ": "); \
for (i = 0; i < sizeof(x)/sizeof(x[0]);i++) printf("%i,", (int)(x[i]));\
printf("\n");}

#define print_ht_tables(dumdum) \
    print_table(HTDC[0].Length);\
    print_table(HTDC[0].minor_code);\
    print_table(HTDC[0].major_code);\
    print_table(HTDC[1].Length);\
    print_table(HTDC[1].minor_code);\
    print_table(HTDC[1].major_code);
/*
    print_table(HTDC[2].Length);\
    print_table(HTDC[2].minor_code);\
    print_table(HTDC[2].major_code);\
    print_table(HTDC[3].Length);\
    print_table(HTDC[3].minor_code);\
    print_table(HTDC[3].major_code);\
    print_table(HTAC[0].Length);\
    print_table(HTAC[0].minor_code);\
    print_table(HTAC[0].major_code);\
    print_table(HTAC[1].Length);\
    print_table(HTAC[1].minor_code);\
    print_table(HTAC[1].major_code);\
    print_table(HTAC[2].Length);\
    print_table(HTAC[2].minor_code);\
    print_table(HTAC[2].major_code);\
    print_table(HTAC[3].Length);\
    print_table(HTAC[3].minor_code);\
    print_table(HTAC[3].major_code);
*/
...
void load_Huffman_table(Huffman_table *HT)
{
    ...
    printf("--------------------\n");    
    DEBUG_MARKER('\n');
    for (i = 0; i < 17;i++) printf("%i,", (int)(HTDC[1].Length[i]));
    DEBUG_MARKER(58);
    printf("\n Length[2]: %i\n", (int)(HTDC[1].Length[2]));
    DEBUG_MARKER('\n');
    for (i = 0; i < 17;i++) printf("%i,", (int)(HT->Length[i]));
    DEBUG_MARKER(59);
    printf("\nLength[2]: %i\n", (int)(HT->Length[2]));
    DEBUG_MARKER(60);
