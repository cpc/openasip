...
architecture structural_dp_dmem of moveproc is
  ...
  component toplevel
    port (
      ...
      fu_fu6_data_in : in std_logic_vector(fu_fu6_dataw-1 downto 0);
      fu_fu6_data_out : out std_logic_vector(fu_fu6_dataw-1 downto 0);
      fu_fu6_addr : out std_logic_vector(fu_fu6_addrw_plus_2-2-1 downto 0);
      fu_fu6_mem_en_x : out std_logic_vector(0 downto 0);
      fu_fu6_wr_en_x : out std_logic_vector(0 downto 0);
      fu_fu6_wr_mask_x : out std_logic_vector(fu_fu6_dataw-1 downto 0);
      fu_fu7_data_in : in std_logic_vector(fu_fu7_dataw-1 downto 0);
      fu_fu7_data_out : out std_logic_vector(fu_fu7_dataw-1 downto 0);
      fu_fu7_addr : out std_logic_vector(fu_fu7_addrw_plus_2-2-1 downto 0);
      fu_fu7_mem_en_x : out std_logic_vector(0 downto 0);
      fu_fu7_wr_en_x : out std_logic_vector(0 downto 0);
      fu_fu7_wr_mask_x : out std_logic_vector(fu_fu7_dataw-1 downto 0));    
  end component;
...
begin  -- struct
  ...
  core : toplevel
    port map (
      ...
      imem_data        => imem_data,
      pc_init          => pc_init,
      fu_fu6_data_in   => dmem_q_a,
      fu_fu6_data_out  => dmem_d_a,
      fu_fu6_addr      => dmem_addr_a,
      fu_fu6_mem_en_x(0)  => dmem_en_a_x,
      fu_fu6_wr_en_x(0)   => dmem_wr_a_x,
      fu_fu6_wr_mask_x => dmem_bit_wr_a_x,
      fu_fu7_data_in   => dmem_q_b,
      fu_fu7_data_out  => dmem_d_b,
      fu_fu7_addr      => dmem_addr_b,
      fu_fu7_mem_en_x(0)  => dmem_en_b_x,
      fu_fu7_wr_en_x(0)   => dmem_wr_b_x,
      fu_fu7_wr_mask_x => dmem_bit_wr_b_x);
