...
entity fu_ld_st_always_3 is
  generic (
    dataw : integer := 32;
    addrw_plus_2 : integer := 12);
  port(
    -- socket interfaces:
    ...
    --mem_address : out std_logic_vector(addrw_plus_2-3 downto 0);
    ...
    clk   : in std_logic;
    rstx  : in std_logic);
end fu_ld_st_always_3;

architecture rtl of fu_ld_st_always_3 is
  ...
  signal o1shadow_reg : std_logic_vector(addrw_plus_2-3 downto 0);
      ...
      if glock = '0' then
        ...
        case sel is
          when TRIG_OP_ST =>
            ...
            data_out_reg <= t1data;
            o1shadow_reg <= o1data(addrw_plus_2-1 downto 2);
            mem_en_x_reg(0) <= '0';
            wr_en_x_reg(0)  <= '0';
