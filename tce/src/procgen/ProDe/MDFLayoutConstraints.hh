...
*/
/**
 * @file MDFLayoutConstraints.hh
 *
 * Declaration of MDFLayoutConstraints class.
 *
...
#ifndef TTA_MDF_LAYOUT_CONSTRAINTS_HH
#define TTA_MDF_LAYOUT_CONSTRAINTS_HH

/**
 * Defines some layout constraints used in visualizing the machine.
 */
class MDFLayoutConstraints {
public:
    /// Minimum unit width.
