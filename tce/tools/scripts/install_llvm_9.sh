...
function fetch_llvm {
    ...
    then
        svn  $REV_TO_FETCH co http://llvm.org/svn/llvm-project/llvm/branches/release_90 $llvm_co_dir \
...
function fetch_clang {
    ...
    if ! test -d clang;
    then
        svn  co http://llvm.org/svn/llvm-project/cfe/branches/release_90 clang \
...
function apply_patches {
    ...
    try_patch $patch_dir/llvm-9-custom-vector-extension.patch
