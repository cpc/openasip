...
def find_libname():
    ...
    for line in f.readlines():
        if line.strip().startswith('nodist_'): continue
        ...
        if match is not None:
            ...
            if libname is None:
                ...
                print "Found two libnames: %s and %s" % \
                      (libname, match.group(1))
                print "Using %s " % libname
                return libname
    return libname
...
for root, dirs, files in os.walk(start_dir):
    ...
    # This header should not be included as it's generated by a Makefile
    ver_str_header = 'tce_version_string.h'
    if ver_str_header in headers: headers.remove(ver_str_header)
