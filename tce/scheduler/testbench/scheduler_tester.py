...
def ParseCommandLine():
    ...
    global configFileName, stopTestingAfterFailingTest, csvFormat, \
           ...
           extraCompileFlags, compiledSimulation
    ...
    try:
        ...
        opts, args = getopt.getopt(\
            sys.argv[args_start:], "g:a:b:shtvVc:Copqrxdli:", ["help"])
...
'''       
    ...
    def runWithArchitecture(self, architecture, seqProgFile):
        ...
        if self.oldResults == None or not architecture in self.oldResults:
            percentage = None
            difference = None
            if normalOutput:
    ...
    def verifyCompiler(self, extraFlags):
        ...
        if access("src/Makefile", R_OK):
            ...
            command = ("cd src;" +
                       makeCommand + 'clean;' +
                       'SCHEDULER_TESTER_FLAGS="'  + extraFlags + '" ' + makeCommand + compileRule)
    ...
    def printSummary(self):
        ...
        if worsened > 0:
            sys.stdout.write(                
                ...
                % (worsened, totalCombinations, (worseningSum / worsened)))
