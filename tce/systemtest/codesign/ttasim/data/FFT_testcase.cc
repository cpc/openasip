/**
 * @file FFT_testcase.cc
 *
 * Behavior definition file for the FFT case.
 *
...
TRIGGER
   ...
   case 0:
     bit_pair0 = (static_cast<unsigned>(INT(4)) >> 8);
     bit_pair1 = ((static_cast<unsigned>(INT(4)) >> 4) & 0x0000000C);
     bit_pair3 = ((static_cast<unsigned>(INT(4)) << 4) & 0x000000C0);
     bit_pair4 = ((static_cast<unsigned>(INT(4)) << 8) & 0x00000300);
     permuted_idx = (bit_pair4 | bit_pair3 | (static_cast<unsigned>(INT(4)) & 0x00000030)
		     | bit_pair1 | bit_pair0);

     // The result addresses for the input permutation.
     IO(5) = (static_cast<unsigned>(INT(1)) + (permuted_idx << 2));
     IO(6) = (static_cast<unsigned>(INT(2)) + (static_cast<unsigned>(INT(4)) << 2));

     break;

     // Generate an address for the operand access.
   default:
     assert(static_cast<unsigned>(INT(3)) > 0);

     rotated_part_width = (static_cast<unsigned>(INT(3)) << 1) + 2;

     /* Rotate the rotated part two bits to the right. */
     upper_part = (((static_cast<unsigned>(INT(4))) >> rotated_part_width)
		   << rotated_part_width);
     rotated_part = (((static_cast<unsigned>(INT(4))) << (32 - rotated_part_width)) >>
   ...
   address = ((rotated_idx << 2) + static_cast<unsigned>(INT(2)));
...
TRIGGER
   ...
   Word(num1) = static_cast<int>(INT(1));
   Word(num2) = static_cast<int>(INT(2));
...
TRIGGER
   ...
   Word(num1) = static_cast<int>(INT(1));
   Word(num2) = static_cast<int>(INT(2));
   Word(num3) = static_cast<int>(INT(3));
   Word(num4) = static_cast<int>(INT(4));

   switch(static_cast<unsigned>(INT(5))) {
   case 0:
...
TRIGGER
  ...
  unsigned int stage = static_cast<unsigned>(INT(1));
  unsigned int linidx = static_cast<unsigned>(INT(2));
...
TRIGGER
   // Local variables for input permutation.
   unsigned int bit_pair0 = 0, bit_pair1 = 0, bit_pair2 = 0, bit_pair3 = 0, 
    bit_pair4 = 0, permuted_idx = 0;
   // Local variables for operand access.
   unsigned int upper_part = 0; unsigned int rotated_part = 0;
   unsigned int rotated_MSB = 0; unsigned int rotated_LSB_part = 0;
   unsigned int rotated_idx = 0; unsigned int address = 0;
   ...
   case 0:
     ...
     if (INT(4) == 64) {
       bit_pair0 = (static_cast<unsigned>(INT(5)) >> 4);
       bit_pair1 = ((static_cast<unsigned>(INT(5)) << 4) & 0x00000030);
       permuted_idx = (bit_pair1 | (static_cast<unsigned>(INT(5)) & 0x0000000C) | bit_pair0);
     } else if (INT(4) == 256) {
       bit_pair0 = (static_cast<unsigned>(INT(5)) >> 6);
       bit_pair1 = ((static_cast<unsigned>(INT(5)) >> 2) & 0x0000000C);
       bit_pair2 = ((static_cast<unsigned>(INT(5)) << 2) & 0x00000030);
       bit_pair3 = ((static_cast<unsigned>(INT(5)) << 6) & 0x000000C0);
       permuted_idx = (bit_pair3 | bit_pair2 | bit_pair1 | bit_pair0);
     } else if (INT(4) == 1024) {
       bit_pair0 = (static_cast<unsigned>(INT(5)) >> 8);
       bit_pair1 = ((static_cast<unsigned>(INT(5)) >> 4) & 0x0000000C);
       bit_pair3 = ((static_cast<unsigned>(INT(5)) << 4) & 0x000000C0);
       bit_pair4 = ((static_cast<unsigned>(INT(5)) << 8) & 0x00000300);
       permuted_idx = (bit_pair4 | bit_pair3 | (static_cast<unsigned>(INT(5)) & 0x00000030)
		       | bit_pair1 | bit_pair0);
     } else {
     ...
     // The result addresses for the input permutation.
     IO(6) = (static_cast<unsigned>(INT(1)) + (permuted_idx << 2));
     IO(7) = (static_cast<unsigned>(INT(2)) + (static_cast<unsigned>(INT(5)) << 2));
   ...
   default:
     ...
     /* Rotate the rotated part two bits to the right. */
     upper_part = (((static_cast<unsigned>(INT(5))) >> rotated_part_width)
		   << rotated_part_width);
     rotated_part = (((static_cast<unsigned>(INT(5))) << (32 - rotated_part_width)) >>
		     (32 - rotated_part_width));
...
TRIGGER
  ...
  unsigned char oper = 0;
  unsigned int stage = static_cast<unsigned>(INT(1));
  unsigned int linidx = static_cast<unsigned>(INT(3));
  unsigned int fft_points = static_cast<unsigned>(INT(2));
