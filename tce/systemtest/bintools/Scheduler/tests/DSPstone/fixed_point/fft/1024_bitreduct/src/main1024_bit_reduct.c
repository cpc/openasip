...
#include "../../common_src/input1024.dat"   /* 1024 real values as
                            input data in float format */

/*
  #include "../../common_src/convert.c" */   /* conversion function to 1.NUMBER_OF_BITS format */

#ifdef __PROF56__
  volatile extern int __time;
  volatile int t;
#include "debug.c"
#endif

#include "../../common_src/fft_bit_reduct.c"

TYPE _Output[N_FFT*2];
